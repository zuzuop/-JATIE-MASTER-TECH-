...
try{   
if (!isGroup) return reply('FOR GROUPS ONLY')
if (!isAdmins) return reply('MAKE ME ADMIN')	
  if (args[1] == 'second') {
                ...
                setTimeout(() => {
                    ...
                    const open = `GROUP OPENED NOW MEMBERS CAN SEND MESSAGES 🔓`
...
if (!isAdmins) return reply(ADMIN)	
                ...
                setTimeout(() => {
                    ...
                    const close = `CLOSE TIME GROUP CLOSED BY PRINCE MDXI\nNOW ONLY ADMIN CAN SEND MESSAGES 🔐`
